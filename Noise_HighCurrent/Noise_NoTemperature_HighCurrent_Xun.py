...
os.chdir('/Users/xunli/Desktop/40010prenoise/4#')
...
#gateincrement=[0.9,1]
#gateincrement=[0.9]
#gateincrement=[0.13,0.1,0.07,0.05]
gateincrement=[0.2,0.13,0.1,0.07,0.05]
...
#    time.sleep(60) #!increase to 60-90 - wait for setting up voltage
    time.sleep(10) #!increase to 60-90 - wait for setting up voltage


    A=meter.read_voltage()

    print "VDS: %s mV" % (float(A)*1000)
...
#   time.sleep(120) #!increase to 60-90 - wait after averaging
    time.sleep(60) #!increase to 60-90 - wait after averaging
...
#    time.sleep(120)
    ...
    deviceinfo='%s_Vgate=%s_%s_fs=%skHz_vd=%s' % (device,Vgate,increment,freq_span,vdrain)
