...
voltsource2=voltage_supply3.VoltageSupply(e5810_addr,gpib=25)
...
#    numbAve=10000
  ...
  #  freqSpan=11 # 8:48.75Hz;9:97.5Hz;10:195Hz;11:390Hz;12:780Hz;13:1.56kHz;14:3.125kHz;15:6.25Hz;16:12.5kHz;17:25kHz;18:50kHz;19:100kHz
   # suggest=11
    ...
    #vth=-4.30714+temperature*(0.000982857)  #200K-425K
...
# temperature control
    ...
    time.sleep(0)    #high speed 90s,DIP 120-150s
    #time.sleep(0)
    #time.sleep(5)    #high speed 90s,DIP 120-150s
    vth=0.84
    #vth=-4.13  #Vth from IV curve
    #vth=-2.18076+temperature*(-0.00231) #85K-300K
    #vth=-2.35686+temperature*(-0.00133) #85K-300K
    #vth=-2.32669+temperature*(-0.00192) #85K-250K
    #vth=-2.32669+temperature*(-0.00192) #85K-200K
    #vth=-1.7029+temperature*(-0.00498)  #200K-250K
...
#    voltsource2.set_voltage_b(Vgate)
    ...
    vdrain,vsupply=set_drain_voltage(left=0,right=10,target=Vgate)
